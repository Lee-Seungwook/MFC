...
BEGIN_MESSAGE_MAP(CMFCApplication1Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_MEMORY_SET, &CMFCApplication1Dlg::OnBnClickedButtonMemorySet)
END_MESSAGE_MAP()
...
void CMFCApplication1Dlg::OnBnClickedButtonMulti()
{
	...
	int iMul = MulXnY(1, 2);
	CString sMsg;
	sMsg.Format(_T("%d"), iMul);
	AfxMessageBox(sMsg);
}


void CMFCApplication1Dlg::OnBnClickedButtonMemorySet()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	SetValue(10);
}
