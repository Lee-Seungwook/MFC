...
CCommonDlgDemoDlg::CCommonDlgDemoDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_COMMONDLGDEMO_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CCommonDlgDemoDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_FILE, &CCommonDlgDemoDlg::OnBnClickedButtonFile)
	ON_BN_CLICKED(IDC_BUTTON_FONT, &CCommonDlgDemoDlg::OnBnClickedButtonFont)
	ON_BN_CLICKED(IDC_BUTTON_COLOR, &CCommonDlgDemoDlg::OnBnClickedButtonColor)
	ON_BN_CLICKED(IDC_BUTTON_BROWSE_FOLDER, &CCommonDlgDemoDlg::OnBnClickedButtonBrowseFolder)
END_MESSAGE_MAP()
...
void CCommonDlgDemoDlg::OnBnClickedButtonFile()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CString strTmp = _T("");
	CFileDialog Dlg(TRUE, _T("EXE"), NULL, OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST, _T("EXE Files(*.exe) | *.exe | All Files(*.*)|*.*||"), this);
	if (Dlg.DoModal() == IDOK)
	{
...
void CCommonDlgDemoDlg::OnBnClickedButtonFont()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CClientDC dc(this);
	...
	wsprintf(lfont.lfFaceName, _T("%s"), _T("궁서"));
...
void CCommonDlgDemoDlg::OnBnClickedButtonColor()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	CString strTmp = _T("");
...
void CCommonDlgDemoDlg::OnBnClickedButtonBrowseFolder()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	BROWSEINFO bi;
