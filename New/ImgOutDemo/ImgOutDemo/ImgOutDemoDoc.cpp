...
CImgOutDemoDoc::CImgOutDemoDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CImgOutDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImgOutDemoDoc::InitializeSearchContent()
{
...
void CImgOutDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
