...
CGdiplusPathDoc::CGdiplusPathDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CGdiplusPathDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CGdiplusPathDoc::InitializeSearchContent()
{
...
void CGdiplusPathDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
