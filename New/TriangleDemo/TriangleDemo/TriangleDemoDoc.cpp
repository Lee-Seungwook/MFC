...
CTriangleDemoDoc::CTriangleDemoDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CTriangleDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CTriangleDemoDoc::InitializeSearchContent()
{
...
void CTriangleDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
