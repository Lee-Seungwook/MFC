...
CGdiplusTransformDoc::CGdiplusTransformDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CGdiplusTransformDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CGdiplusTransformDoc::InitializeSearchContent()
{
...
void CGdiplusTransformDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
